...
<html>
            ...
            function uploadFile() {
                ...
                if (confirm("등록 하시겠습니까?")) {
                    ...
                    for (var i = 0; i < uploadFileList.length; i++) {
                        ...
                        formData.append('input_file', fileList[uploadFileList[i]]);
                    }
                    $.ajax({
    ...
    <body>
      ...
      <input type="button" onclick="uploadFile(); return false;" id="uploadForm" class="btn bg_01" value="파일 업로드">
        </form>
    </body>
</html>
