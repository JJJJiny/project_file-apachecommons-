		...
		try {
			if(cmd.contentEquals("/upload.file")) {
				...
				if (isMultipart) {
					...
					//String path = "C:/eclipse/workspace/fileupload/WebContent/upfolder";
					...
					//File store = (File)serveltContext.getAttribute(System.getProperty("java.io.tmpdir"));
					//factory.setRepository(store); //파일 임시 저장소
					//factory.setRepository(new File(System.getProperty("java.io.tmpdir")));
					//String path = System.getProperty("java.io.tmpdir");
					//System.out.println(path); //C:\Users\Jinny\AppData\Local\Temp\
